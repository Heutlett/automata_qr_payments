...
namespace Api.Migrations
{
    ...
    [Migration("20230616023603_ShareAccount")]
    partial class ShareAccount
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Api.Models.CuentaCompartida", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Api.Models.CuentaCompartida", b =>
                {
                    b.HasOne("Api.Models.Cuenta", "Cuenta")
                        .WithMany()
                        .HasForeignKey("CuentaId");

                    b.HasOne("Api.Models.Usuario", "Usuario")
                        .WithMany("CuentasCompartidas")
                        .HasForeignKey("UsuarioId");
            ...
            modelBuilder.Entity("Api.Models.Usuario", b =>
                {
                    b.HasOne("Api.Models.Cuenta", null)
                        .WithMany("UsuariosCompartidos")
                        .HasForeignKey("CuentaId");
                });

            modelBuilder.Entity("Api.Models.Cuenta", b =>
                {
                    b.Navigation("UsuariosCompartidos");
                });

            modelBuilder.Entity("Api.Models.Usuario", b =>
                {
                    b.Navigation("CuentasCompartidas");
                });
