...
const homeLoggedRouteName = '/home_logged';
...
const showSelectedAccountsRouteName = '/show_selected_accounts';

const createFacturaRouteName = '/create_factura';
const showFacturaRouteName = '/show_factura';

const facturasHistoryRouteName = '/facturas_history';
