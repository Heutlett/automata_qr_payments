...
--
-- Table structure for table `cuentascompartidas`
--
...
CREATE TABLE `cuentascompartidas` (
  ...
  KEY `IX_CuentasCompartidas_CuentaCompartidaId` (`CuentaCompartidaId`),
...
--
-- Dumping data for table `cuentascompartidas`
--

LOCK TABLES `cuentascompartidas` WRITE;
/*!40000 ALTER TABLE `cuentascompartidas` DISABLE KEYS */;
INSERT INTO `cuentascompartidas` VALUES (5,2),(4,3),(4,4);
/*!40000 ALTER TABLE `cuentascompartidas` ENABLE KEYS */;
UNLOCK TABLES;
