...
--
-- Table structure for table `actividadcuenta`
--
...
CREATE TABLE `actividadcuenta` (
  ...
  KEY `IX_ActividadCuenta_CuentasId` (`CuentasId`),
...
--
-- Dumping data for table `actividadcuenta`
--

LOCK TABLES `actividadcuenta` WRITE;
/*!40000 ALTER TABLE `actividadcuenta` DISABLE KEYS */;
INSERT INTO `actividadcuenta` VALUES (721001,1),(723001,1),(154301,4),(154903,4),(154908,4),(552005,5);
/*!40000 ALTER TABLE `actividadcuenta` ENABLE KEYS */;
UNLOCK TABLES;
